...
// var deprofundis_base = {
//   "introduction": "<p>Aujourd'hui nous faisons mémoire de nos frères : </p>",
//   "psaume_1": {
//     "reference": "Psaume 129",
//     "titre": "De Profundis",
...
function create_office_html(office, date, zone, hymne, invitatoire, contenu_aelf, contenu_dominicain=null, hymne_selected){
  ...
  switch (office) {
    ...
    case "messes":
      ...
      break; 
    case "deprofundis":
      return create_deprofundis_html(contenu_aelf["informations"], date_obj);
      break;
    case "martyrologe":
      return create_martyrologe_html(contenu_aelf["informations"], date_obj);
      break;
    default:
  }
}
...
function create_deprofundis_html(infos, date_obj){
  var titre = '<div class="office_titre" id="office_titre">';
...
function create_martyrologe_html(infos, date_obj){
  var titre = '<div class="office_titre" id="office_titre">';
